...
#define BMP_LOCAL_PATH BMP_RES_PATH"监控/"
...
static BmpLocation bmp_load[] = {
    {&bmp_title, BMP_LOCAL_PATH"监控(x69，y89).JPG"},
    {&bmp_icon, BMP_LOCAL_PATH"监控图标(x151，y223).JPG"},
};
...
void formMonitorLoadBmp(void)
{
    ...
    if (g_config.device_main_controls[IDC_MONITOR] == 0)
        return;
 ...
 */
/* ----------------------------------------------------------------*/
int createFormMonitor(HWND hMainWnd)
{
