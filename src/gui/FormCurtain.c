 ...
 *----------------------------------------------------------------------------*/
static int formCurtainProc(HWND hDlg, int message, WPARAM wParam, LPARAM lParam);
...
static MgCtrlButton opt_controls[] = {
	{0,	0x8d,"全窗帘合",194,459,93,52},
	{0,	0xac,"全窗帘开",194,404,93,55},
	{0,	0x81,"尾窗帘合",246,573,94,48},
	{0,	0xa9,"尾窗帘开",141,573,93,48},
	{0,	0x93,"右窗帘合",318,459,91,52},
	{0,	0x96,"右窗帘开",318,404,91,55},
	{0,	0x8f,"左窗帘合",69,459,93,52},
	{0,	0x80,"左窗帘开",69,404,93,55},
};
 ...
 */
/* ----------------------------------------------------------------*/
int createFormCurtain(HWND hMainWnd)
{
